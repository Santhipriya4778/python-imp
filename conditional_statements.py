...
'''
Task 7
practice operators , conditional statements ,jumping staements, looping statements
Task 8
prepare a doc on operators , conditional statements ,jumping staem
Task 9
explore stackover flow
